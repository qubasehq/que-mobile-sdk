...
import com.que.platform.android.overlay.DebugOverlayController
...
class QueAccessibilityService : AccessibilityService(), GestureController {
    ...
    override fun onServiceConnected() {
        ...
        com.que.core.registry.ServiceManager.registerAccessibilityService(this)
        ...
        // NOTE: QueConversationalService auto-start is disabled.
        // The voice/wake-word service requires Picovoice API key and model files.
        // If these are not configured, the foreground service crashes during onCreate(),
        // which kills the accessibility service process and causes Android to show
        // "service malfunctioning". Start it explicitly when voice features are needed.
        // try {
    ...
    private var appLauncher: com.que.platform.android.util.AppLauncher? = null
    ...
    override fun onDestroy() {
        ...
        com.que.core.registry.ServiceManager.unregisterAccessibilityService()
        scope.cancel()
    }
