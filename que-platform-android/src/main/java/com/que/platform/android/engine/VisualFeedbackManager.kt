...
import com.que.platform.android.overlay.AudioWaveView
...
class VisualFeedbackManager private constructor(private val context: Context) {
    ...
    private var audioWaveView: com.que.platform.android.overlay.AudioWaveView? = null
    ...
    private fun setupAudioWaveEffect() {
        ...
        try {
            audioWaveView = com.que.platform.android.overlay.AudioWaveView(context)
            val heightInDp = 150
